...
@section('content')
    <div class="mb-4">
        <span class="text-lg font-bold tracking-wide text-green-600 dark:text-gray-200">New Product</span>
    </div>

    <div class="bg-white dark:bg-gray-700 p-4 rounded-md">
        <form id="form-product" action="{{ route('product.store') }}" method="POST">
            @csrf
